    ...
    const printBodyTable = (claim, index) => {
        return (
            <tr key={index} role="row" className="odd">
                <td>{claim.reference ? claim.reference : ""} {claim.is_rejected ? (
                ...
                <td>
                    <a href={`/process/claim-unsatisfied/${claim.id}/detail`}
            ...
            <div className="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                ...
                <div className="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                    <InfirmationTable information={(
                        <div>
                            {t("Cette page présente la liste des réclamations complètes non satisfaites")}
                            <br/>
                    ...
                    <div className="kt-portlet">
                        <HeaderTablePage
                            title={t("Réclamations non satisfaites")}
                        />
