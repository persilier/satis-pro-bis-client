...
const TypeClient = (props) => {
    ...
    document.title = (ready ? "Satis client - Paramètre Type client" : "");
            ...
            verifyPermission(props.userPermissions, "list-position") ? (
                <div className="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                    ...
                    <div className="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                        <InfirmationTable
                            information={t("Liste des types client")}/>

                        <div className="kt-portlet">
                            <HeaderTablePage
                                addPermission={"store-type-client"}
                                title={t("Type Client")}
                                addText={t("Ajouter un Type Client")}
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12 col-md-5">
                                                    <div className="dataTables_info" id="kt_table_1_info" role="status"
                                                         aria-live="polite">
                                                        {typeClient.length ?
                                                            `${t("Affichage de")} 1 ${t("à")} ${numberPerPage} ${t("sur")} ${typeClient.length} ${t("données")}`
                                                            :
