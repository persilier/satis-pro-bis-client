...
const ParametersComponent = (props) => {
  ...
  document.title = ready
    ? t("Satis Client - Paramètre configuration formulaire")
    : "";
  ...
  useEffect(() => {
    async function fetchData() {
      axios
        .get(appConfig.apiDomaine + "/components")
        .then((response) => {
  ...
  const filterShowListBySearchValue = (value) => {
    ...
    newComponent = newComponent.filter(
      (el) => getLowerCaseString(el.name ? el.name : "").indexOf(value) >= 0
    );
      ...
      >
        ...
        <div className="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
          ...
          <div className="kt-portlet">
            <HeaderTablePage title={t("Configuration")} />
            {load ? (
              <LoadingTable />
            ) : (
                  ...
                  <div className="row">
                    <div className="col-sm-12 col-md-5">
                      ...
                      >
                        ...
                        {t("sur")} {component.length} {t("données")}
                      </div>
                    </div>
                    {showList.length ? (
