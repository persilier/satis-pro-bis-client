...
const HistoricClaimsAdd = (props) => {
  ...
  useEffect(() => {
    async function fetchData() {
      axios
        .get(appConfig.apiDomaine + "/history/list-claim")
        .then((response) => {
          setLoad(false);
    ...
    return (
      <tr key={index} role="row" className="odd">
        ...
        <td data-sort="claimObject.name">
          {claim.claim_object ? claim.claim_object.name["fr"] : ""}
        </td>
        ...
        <td data-sort="status" style={{ textAlign: "center" }}>
