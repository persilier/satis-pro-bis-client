...
const ClaimReassignPending = (props) => {
  ...
  useEffect(() => {
    async function fetchData() {
      axios
        .get(`${appConfig.apiDomaine}/claim-reassignment/?type=unsatisfied`)
        .then((response) => {
  ...
  const printBodyTable = (claim, index) => {
    return (
      <tr key={index} role="row" className="odd">
        ...
        <td>
          <a
            href={`/process/claim-reassign-pending/${claim.id}`}
              ...
              <div className="kt-subheader__breadcrumbs">
                ...
                <div className="kt-subheader__breadcrumbs">
                  ...
                  <a
                    ...
                    style={{ cursor: "text" }}
                  >
                    {t("Réclamations non satisfaites à réassigner")}
                  </a>
                </div>
              </div>
            </div>
...
export default connect(mapStateToProps)(ClaimReassignPending);
